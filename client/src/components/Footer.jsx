...
const Footer = () => {
  // ==================== DATA & CONSTANTS ====================
  const companyInfo = {
    name: "BalswasthyaBabycare Platform",
    description:
    ...
    trustBadge: "Trusted by 10,00+ families",
  };
  ...
  const contactInfo = [
    {
      type: "email",
      label: "Email",
      value: "helpBalswasthyaBabycare@gmail.com",
      href: "mailto:helpBalswasthyaBabycare@gmail.come",
      icon: Mail,
    },
    {
      type: "phone",
    ...
    },
    {
      type: "address",
      label: "Address",
      value: "456 Wellness Street, Caretown, CT 67890",
      href: null,
      icon: MapPin,
    },
  ];
  ...
  const handleNewsletterSubmit = (e) => {
    ...
    // send to backend
    fetch(commnApiEndpoint.newsletter.url, {
      method: 'POST',
      ...
      <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
        ...
        <div className="text-center md:text-left">
          <p className="text-gray-300 text-lg">
            &copy; 2025   BalswasthyaBabycare. All rights reserved.
          </p>
        </div>
